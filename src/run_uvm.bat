...
dsim -uvm 1.2 ..\tb\interfaces\axi4_interface.sv ..\tb\tests\axi4_base_test.sv ..\tb\top\tb_top.sv +acc -waves waves.vcd +UVM_VERBOSITY=UVM_MEDIUM +UVM_TESTNAME=Axi4_Base_Test
